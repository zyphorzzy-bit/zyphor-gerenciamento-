...
client.once("ready", async () => {
  ...
  try {
    ...
    console.error(`${e.proibido} Erro ao registrar /gerenciador:`, err);
  }
});
  ...
  if (interaction.isChatInputCommand()) {
    ...
    if (!config.owners.includes(interaction.user.id)) {
      return interaction.reply({
        content:
          `${e.proibido} Você não possui permissão para acessar este painel.`,
        ephemeral: true
      });
    }
  ...
  switch (interaction.customId) {
    ...
    case "gerenciar":
      return interaction.reply({
        content:
          ...
          `${e.seta} Sistema de gerenciamento de bots.\n\n` +
          `> Em breve: adicionar, editar, remover e transferir bots.`,
        ephemeral: true
      });
    ...
    case "expiracoes":
      return interaction.reply({
        content:
          ...
          `${e.ativo} Sistema de expiração preparado para a próxima etapa.`,
        ephemeral: true
      });
    ...
    case "config":
      return interaction.reply({
        content:
          ...
          `${e.seta} Configurações do gerenciador ficarão aqui.`,
        ephemeral: true
      });
    ...
    case "suporte":
      return interaction.reply({
        content:
          `${e.suporte} **Suporte**\n\n` +
          `${e.seta} Sistema de suporte em preparação.`,
        ephemeral: true
      });
  }
});
