...
// -------------------------------------------------------------
// 6. LOGIN DO BOT E DIAGNÓSTICO
// -------------------------------------------------------------
const tokenParaTestar = (process.env.DISCORD_TOKEN || 'SEU_TOKEN_AQUI').trim();

console.log('------------------------------------');
console.log('🔍 DIAGNÓSTICO DE TOKEN DA SHARDCLOUD:');
console.log('-> Tamanho do Token:', tokenParaTestar.length);
console.log('-> Início:', tokenParaTestar.slice(0, 10) + '...');
console.log('------------------------------------');

client.login(tokenParaTestar);
