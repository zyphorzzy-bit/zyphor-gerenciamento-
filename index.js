...
client.once('ready', () => {
    ...
    // Configura o status de Stream no perfil do bot
    client.user.setPresence({
        activities: [{
            name: 'Zyphor System • Gerenciamento',
            type: ActivityType.Streaming,
            url: 'https://www.twitch.tv/discord' // URL necessária para ativar o modo roxo (Streaming)
        }],
        status: 'online'
    });
});
...
// -------------------------------------------------------------
// 3. CRIAÇÃO E ATUALIZAÇÃO DE TÓPICOS DOS CLIENTES
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// 4. COMANDOS ADMINISTRATIVOS E PAINEL
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// 5. EVENTOS E PROCESSAMENTO DE MODAIS/BOTÕES
// -------------------------------------------------------------
